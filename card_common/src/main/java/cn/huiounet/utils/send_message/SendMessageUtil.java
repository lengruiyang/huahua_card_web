...
// 签名
    ...
    public static String getMess2(String tel,String code)throws Exception{
        // 短信应用SDK AppID
        int appid = 1400389620; // 1400开头
...
// 短信模板ID，需要在短信应用中申请
        int templateId = 725350; // NOTE: 这里的模板ID`7839`只是一个示例，真实的模板ID需要在短信控制台中申请
...
// 签名
    ...
    public static String getMess3(String tel,String code)throws Exception{
        // 短信应用SDK AppID
        int appid = 1400389620; // 1400开头
...
// 短信模板ID，需要在短信应用中申请
        int templateId = 581447; // NOTE: 这里的模板ID`7839`只是一个示例，真实的模板ID需要在短信控制台中申请
