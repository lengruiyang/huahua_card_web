...
public class QRCodeUtil {
    ...
    public static BufferedImage addNote(BufferedImage image,String note){
        ...
        if (note.length()<=16) {
            ...
            g2.drawString(note,300/2-note.length()*8-14, 300+font.getSize());
        }else{
            g1.fillRect(0, 300, 300, 45);
            g2.drawString(note.substring(0, 16),5, 300+font.getSize());
            g2.drawString(note.substring(16,note.length()), 300/2-(note.length()-16)*8-14, 300+font.getSize()*2+4);
        }
