...
public class ImageRemarkUtil {
    ...
    // 水印文字字体
    private static Font font = new Font("微软雅黑", Font.BOLD, 25);
    // 水印文字颜色
    ...
    public static void markImageByText(String logoText, String srcImgPath,
        ...
        markImageByText(logoText, srcImgPath, targerPath, null ,width,height);
    }
    ...
    public static void SY(String srcImgPath,String targerTextPath,String logoText) {
        ...
        markImageByText(logoText, srcImgPath, targerTextPath,sourceImg.getWidth()-(25*logoText.length()),sourceImg.getHeight()-25);
